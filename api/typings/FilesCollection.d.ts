declare module "meteor/ostrio:files" {
    ...
    interface FilesCollectionConfig {
        ...
        ddp?: Object;
        cacheControl?: string;
        responseHeaders?: { [x: string]: string } | ((responseCode?: any, fileRef?: any, versionRef?: any, version?: any) => { [x: string]: string });
    ...
    export class FilesCollection {
        ...
        find(selector?: Mongo.Selector<FileObj>, options?: SearchOptions): FilesCursor;
        findOne(selector?: Mongo.Selector<FileObj>, options?: SearchOptions): FileCursor;
        insert(settings: InsertOptions, autoStart?: boolean): FileUpload;
        remove(select: Mongo.Selector<FileObj>, callback: (error: any) => any): FilesCollection;
        ...
        load(url: string, opts: LoadOptions, callback: (err: any, fileRef: FileRef) => any, proceedAfterUpload: boolean): any;
        write(buffer:Buffer, opts: LoadOptions, callback: (err: any, fileRef: FileRef) => any, proceedAfterUpload: boolean): any;
    }
}
